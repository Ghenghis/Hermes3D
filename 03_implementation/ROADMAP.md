...
- Current live smoke proof for this workbench slice: folder-index and MCP lock readiness pass, but MiniMax and DeepSeek execution are both blocked by HTTP 401 from their configured private keys. The route now returns redacted blocked reasons and evidence instead of crashing or claiming a usable provider.
