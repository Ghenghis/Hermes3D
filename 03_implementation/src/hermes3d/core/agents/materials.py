...
MATERIALS: Tuple[MaterialProfile, ...] = (
    MaterialProfile(
        material="PLA",
        hotend_min_c=190, hotend_typical_c=210, hotend_max_c=230,
        bed_min_c=0,     bed_typical_c=60,     bed_max_c=70,
        notes="Universal — any printer can run PLA.",
    ),
    MaterialProfile(
        material="PLA+",
        hotend_min_c=200, hotend_typical_c=215, hotend_max_c=235,
        bed_min_c=45,    bed_typical_c=60,     bed_max_c=70,
        notes="Toughened PLA — eSun, Polymaker variants.",
    ),
    MaterialProfile(
        material="PETG",
        hotend_min_c=225, hotend_typical_c=240, hotend_max_c=255,
        bed_min_c=70,    bed_typical_c=80,     bed_max_c=90,
        notes="Tough, slight stringing. Most printers handle it.",
    ),
    MaterialProfile(
        material="ABS",
        hotend_min_c=235, hotend_typical_c=250, hotend_max_c=270,
        bed_min_c=95,    bed_typical_c=105,    bed_max_c=110,
    ...
    MaterialProfile(
        material="ASA",
        hotend_min_c=240, hotend_typical_c=255, hotend_max_c=270,
        bed_min_c=95,    bed_typical_c=105,    bed_max_c=115,
        requires_enclosure=True,
        notes="Worse than ABS for warping; enclosure required.",
    ),
    MaterialProfile(
        material="TPU",
        hotend_min_c=215, hotend_typical_c=230, hotend_max_c=250,
        bed_min_c=40,    bed_typical_c=55,     bed_max_c=70,
        requires_direct_drive=True,
        notes="Flexible; bowden tubes cause buckling. Direct-drive required.",
    ),
    MaterialProfile(
        material="PA",  # nylon
        hotend_min_c=240, hotend_typical_c=270, hotend_max_c=290,
        bed_min_c=80,    bed_typical_c=95,     bed_max_c=110,
        prefers_enclosure=True,
        notes="Hygroscopic — dry filament well. High hotend preferred.",
    ),
    MaterialProfile(
        material="PA-CF",
        hotend_min_c=250, hotend_typical_c=275, hotend_max_c=295,
        bed_min_c=80,    bed_typical_c=100,    bed_max_c=115,
    ...
    MaterialProfile(
        material="PC",
        hotend_min_c=275, hotend_typical_c=295, hotend_max_c=315,
        bed_min_c=100,   bed_typical_c=110,    bed_max_c=120,
        requires_enclosure=True,
        notes="Polycarbonate — needs very hot hotend + heated chamber.",
    ),
    MaterialProfile(
        material="CF-PLA",
        hotend_min_c=200, hotend_typical_c=220, hotend_max_c=240,
        bed_min_c=45,    bed_typical_c=60,     bed_max_c=70,
        requires_hardened_nozzle=True,
    ...
    MaterialProfile(
        material="PVA",
        hotend_min_c=180, hotend_typical_c=200, hotend_max_c=220,
        bed_min_c=45,    bed_typical_c=60,     bed_max_c=70,
